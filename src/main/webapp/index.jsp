<%@ page
	import="com.samltestapp.saml.Identity,com.samltestapp.util.Bag,java.util.Set,java.util.Iterator,java.util.ArrayList"%>
<%
...
<body>
	...
	%>
	<div class="centered">
		<span class=""><a href="/_saml?RelayState=%2F"
			class="button center">Login</a></span>
	</div>
